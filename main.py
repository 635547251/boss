    ...
    try:
        ...
        for k in order_build_data["data"]:
            ...
            # 有多个
                ...
                delivery_method.update({"id": k.split("_")[1], "tag": "deliveryMethod"})
                ...
                confirm_order.update({"id": k.split("_")[1], "tag": "confirmOrder"})
                ...
                service_yfx.update({"id": k.split("service_")[1], "tag": "service"})
                service_yfx_dict = json.dumps(service_yfx, ensure_ascii=False, separators=(
                    ',', ':')).replace('"', r'\\\"').replace(r'\\\\"', r'\\\\\\\"')
                print(service_yfx_dict)
