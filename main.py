...
def main(cookies):
    ...
    try:
        ...
        address = order_build_data["data"]["address_1"]
        address.update({"id": "1", "tag": "address"})
        address["fields"]["cornerType"] = "both"
        address_dict = json.dumps(address, ensure_ascii=False, separators=(',', ':')).replace(
...
if __name__ == "__main__":
    ...
    main({})
    '''
    {"params":"{\"data\":\"{\\\"itemInfo_ab96af10ec01db7dfd2b9fbefe406c91\\\":"%s",\\\"item_ab96af10ec01db7dfd2b9fbefe406c91\\\":"%s",\\\"address_1\\\":"%s",\\\"invoice_2f426b0c3ea8b56f75ad8354ad85afd7\\\":"%s",\\\"promotion_2f426b0c3ea8b56f75ad8354ad85afd7\\\":"%s",\\\"deliveryMethod_2f426b0c3ea8b56f75ad8354ad85afd7\\\":"%s",\\\"anonymous_1\\\":"%s",\\\"voucher_1\\\":"%s",\\\"confirmOrder_1\\\":"%s",\\\"service_yfx_2f426b0c3ea8b56f75ad8354ad85afd7\\\":"%s",\\\"ncCheckCode_ncCheckCode1\\\":"%s",\\\"submitOrder_1\\\":"%s",\\\"promotion_ab96af10ec01db7dfd2b9fbefe406c91\\\":"%s",\\\"memo_2f426b0c3ea8b56f75ad8354ad85afd7\\\":"%s"}\",\"linkage\":\""%s"\",\"hierarchy\":\"{\\\"structure\\\":"%s"}\",\"endpoint\":\""%s"\"}"}
    '''
